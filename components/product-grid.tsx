...
const products = [
  ...
  },
  {
    id: 6,
    name: "Bamboo Basket",
    description: "Intricately woven bamboo basket with geometric patterns",
    price: 1800,
    image: "/placeholder.svg?height=400&width=400",
    artist: "Suresh Rathwa",
    category: "Home Decor",
    featured: false,
    certified: true,
  },
  {
    ...
    description: "Hand-embroidered wall hanging depicting tribal life",
    price: 4500,
    image: "/placeholder.svg?height=400&width=400",
    artist: "Savita Rathwa",
    category: "Textiles",
  ...
  },
  {
    id: 8,
    name: "Tribal Mask",
    description: "Wooden mask used in traditional Rathwa ceremonies",
    price: 6500,
    image: "/placeholder.svg?height=400&width=400",
    artist: "Bharat Rathwa",
    category: "Sculptures",
  ...
  },
  {
    ...
    description: "Traditional beaded necklace with tribal patterns",
    price: 2200,
    image: "/placeholder.svg?height=400&width=400",
    artist: "Leela Rathwa",
    category: "Jewelry",
